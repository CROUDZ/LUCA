      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Créez, partagez et découvrez des nodes personnalisés pour étendre les fonctionnalités de
            LUCA. La plateforme communautaire pour vos automatisations.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-gray-400">
                Uploadez votre mod sur la plateforme. Il sera validé automatiquement puis disponible
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-gray-400">
                Installez les mods directement depuis l&apos;app Android. Vos nouveaux nodes
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Logic', 'Math', 'Timing', 'Network', 'Device', 'Data', 'UI', 'Other'].map(
              (category) => (
                <Link
                  key={category}
