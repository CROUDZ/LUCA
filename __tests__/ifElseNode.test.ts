    ...
    const nodes = new Map([
      ...
      [
        2,
        {
          ...
          data: { settings: { conditionType: 'expression', expression: 'signal.data.pass' } },
          inputs: [1],
          outputs: [3],
        },
      ],
    ...
    const nodes = new Map([
      ...
      [
        2,
        {
          ...
          name: 'IfElse',
          type: 'condition.if-else',
          data: { settings: { conditionType: 'variable', variableName: 'flag' } },
          inputs: [1],
          outputs: [3],
        },
      ],
    ...
    const nodes = new Map([
      ...
      [
        2,
        {
          ...
          type: 'condition.if-else',
          data: {
            settings: { conditionType: 'expression', expression: 'true', invertSignal: true },
          },
          inputs: [1],
          outputs: [3],
        },
    ...
    const nodes = new Map([
      ...
      [
        2,
        {
          ...
          name: 'IfElse',
          type: 'condition.if-else',
          data: { settings: { conditionType: 'expression', expression: 'process.exit(1)' } },
          inputs: [1],
          outputs: [3],
        },
      ],
